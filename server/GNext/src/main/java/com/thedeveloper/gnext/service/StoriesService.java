...
@Service
@Slf4j
public class StoriesService implements StorageService {
    private final Path rootLocation;

    public StoriesService(StoriesProperties properties) {
        this.rootLocation = Paths.get(properties.getLocation());
    }

    @Override
    public void init() {
        log.info("Stories INIT Abs: "+rootLocation.toAbsolutePath());
        try {

...
import com.thedeveloper.gnext.utils.storage.ImageProperties;
import com.thedeveloper.gnext.utils.storage.StorageException;
import com.thedeveloper.gnext.utils.storage.StorageFileNotFoundException;
import com.thedeveloper.gnext.utils.storage.StorageService;
...
public class ImageService implements StorageService {
    ...
    @Override
    public void init() {
        log.info("Image INIT Abs: "+rootLocation.toAbsolutePath());
        try {

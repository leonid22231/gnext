...
abstract class RestClient {
  ...
  Future<UserEntity> forgotPasswordConfirm(@Query("phone") String phone, @Query("password") String password, @Query("uid") String uid);
  @MultiPart()
  @POST("chat/file")
  ...
  @GET("location/country/byCity")
  Future<CountryEntity> findCountryByCity(@Query("id") int cityId);
  @POST("orders/create")
  @MultiPart()
  ...
  @GET("user/findChat")
  Future<String> findChat(@Query("uid") String uid, @Query("client") String client, @Query("companyId") int? companyId);
  @POST("user/createCompany")
  Future<void> createCompany(@Query("uid") String uid, @Query("category") Categories category, @Query("name") String name, @Query("phone") String? phone, @Query("street") String street, @Query("house") String house, @Part(name: "photo") File? file);

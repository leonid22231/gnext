...
abstract class RestClient {
  ...
  @GET("orders/my")
  Future<List<OrderEntity>> myOrders(@Query("uid") String uid,
      @Query("outcity") bool outcity, @Query("mode") OrderMode mode);
  @GET("orders/search")
  ...
  @POST("user/save")
  Future<void> saveUser(@Query("uid") String uid,
      @Query("telegram") String? telegram, @Query("whatsapp") String? whatsapp);
}

...
class CustomChatPage extends StatefulWidget{
  ...
  const CustomChatPage({this.onUpdate,this.readOnlyUser,required this.showTitle,required this.title,required this.chatName,this.subscription,this.history, super.key});
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
                    ...
                    return SizedBox(
                      ...
                      child: ListView(
                        ...
                        children: snapshot.data!.reversed.map((message) => message.type==MessageType.USER?InkWell(
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        subscription&&message.user.uid!=GlobalsWidgets.uid&&(message.user.role!=UserRole.ADMIN&&message.user.role!=UserRole.MANAGER)?SizedBox(width: 2.w,):const SizedBox.shrink(),
                                        subscription&&message.user.uid!=GlobalsWidgets.uid&&(message.user .role!=UserRole.ADMIN&&message.user.role!=UserRole.MANAGER)?Icon(Icons.person, color: GlobalsColor.blue,):const SizedBox.shrink(),
                          ...
                          child: Align(
                            alignment: message.user.uid==GlobalsWidgets.uid?Alignment.centerRight:Alignment.centerLeft,
                            child: Column(
            ...
            readOnlyUser!=null&&readOnlyUser==GlobalsWidgets.role?const SizedBox.shrink():Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                AnimatedSwitcher(

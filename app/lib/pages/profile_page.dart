              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    user.role==UserRole.SPECIALIST?Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Row(
                          children: [
                            Icon(Icons.wallet_outlined, color: Colors.white,size: 8.w,),
                            SizedBox(width: 3.w,),
                              ...
                              showDialog(context: context,
                                  builder: (context){
                                    return StatefulBuilder(builder: (context, state){
                                      return AlertDialog(
                                        title: Text(S.of(context).payment,style: TextStyle(fontSize: 16.sp),),
                                        content: Column(
                                          ...
                                          children: [
                                                OutlinedButton(
                                                    ...
                                                    child: const Text("Russia - Visa / Master Card / МИР", textAlign: TextAlign.center,style: TextStyle(color: Colors.black),)
                                                ),
                                            SizedBox(height: 1.h,),
                                            OutlinedButton(
                                                onPressed: () async {
                                                  showDialog(context: context,
                                                      builder: (context){
                                                        return StatefulBuilder(builder: (context, state){
                                                          return AlertDialog(
                                                            title: Text(S.of(context).enter_money,style: TextStyle(fontSize: 16.sp),),
                                                            content: Column(
                                                              mainAxisSize: MainAxisSize.min,
                                                              children: [
                                                                Text(S.of(context).min_sum,style: TextStyle(fontSize: 14.sp),),
                                                                SizedBox(
                                                                  height: 8.h,
                                                                  child: TextFormField(
                                                                    onChanged: (value){
                                                                ...
                                                                Builder(builder: (context){
                                                                  try{
                                                                    ...
                                                                    return FutureBuilder(future: convertToUsd(double.parse(count)), builder: (context,snapshot){
                                                                      if(snapshot.hasData){
                                                                        money = snapshot.data!;
                                                                        return Text("Примерная сумма перевода ${snapshot.data} \$",style: TextStyle(fontSize: 14.sp),);
                                                                      }else{
                                                ...
                                                child: const Text("All World - Visa / Master Card / American Express", textAlign: TextAlign.center,style: TextStyle(color: Colors.black),)
                                            ),
                                          ],
                                        ),
                                        actions: [
              ...
              onTap: (){
                showDialog(context: context,
                    builder: (context){
                      return StatefulBuilder(builder: (context, state){
                        return AlertDialog(
                          title: Text(S.of(context).help,style: TextStyle(fontSize: 16.sp),),
                          content: Column(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              OutlinedButton(
                                ...
                                ), child: Text(S.of(context).help, style: const TextStyle(color: Colors.white),),),
                              SizedBox(height: 2.h,),
                              OutlinedButton(
                                onPressed: (){
                                ...
                                style: OutlinedButton.styleFrom(
                                    ...
                                    side: BorderSide.none
                                ), child: Text(S.of(context).help_1, style: const TextStyle(color: Colors.white),),),
                            ],
                          ),
                          actions: [
                            TextButton(

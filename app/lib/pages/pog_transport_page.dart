...
class PogTransportPage extends StatefulWidget {
  final bool sub;
  final CityEntity city;
  const PogTransportPage({required this.sub, required this.city, super.key});

  @override
  State<StatefulWidget> createState() => PogTransportPageState();
}

class PogTransportPageState extends State<PogTransportPage>
  ...
  CityEntity? kuda;
  DateTime? date;
  TransportationCategory category = TransportationCategory.pog;
  List<String> res = [];
  @override
  void initState() {
    super.initState();
        ...
        children: [
          ButtonsTabBar(
            ...
            onTap: (index) {
              ...
              ChangeModePogNotify(selectedMode).dispatch(context);
              setState(() {});
            },
            tabs: [
              Tab(
                ...
                children: [
                  FutureBuilder(
                      future: RestClient(Dio()).searchOrders(
                          OrderMode.POG, widget.city.id, widget.city.id),
...
class ChangeModePogNotify extends Notification {
  Mode mode;
  ChangeModePogNotify(this.mode);
}

...
class ExTransportPage extends StatefulWidget {
  final bool sub;
  final CityEntity city;
  const ExTransportPage({required this.sub, required this.city, super.key});

  @override
  State<StatefulWidget> createState() => ExTransportPageState();
}

class ExTransportPageState extends State<ExTransportPage>
  ...
  CityEntity? kuda;
  DateTime? date;
  TransportationCategory category = TransportationCategory.ex;
  List<String> res = [];
  @override
  void initState() {
    super.initState();
        ...
        children: [
          ButtonsTabBar(
            ...
            onTap: (index) {
              ...
              ChangeModeExNotify(selectedMode).dispatch(context);
              setState(() {});
            },
            tabs: [
              Tab(
                ...
                children: [
                  FutureBuilder(
                      future: RestClient(Dio()).searchOrders(
                          OrderMode.EX, widget.city.id, widget.city.id),
...
class ChangeModeExNotify extends Notification {
  Mode mode;
  ChangeModeExNotify(this.mode);
}

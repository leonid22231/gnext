...
class ManTransportPage extends StatefulWidget {
  final bool sub;
  final CityEntity city;
  const ManTransportPage({required this.sub, required this.city, super.key});

  @override
  State<StatefulWidget> createState() => ManTransportPageState();
}

class ManTransportPageState extends State<ManTransportPage>
  ...
  CityEntity? kuda;
  DateTime? date;
  TransportationCategory category = TransportationCategory.man;
  List<String> res = [];
  @override
  void initState() {
    super.initState();
    ...
    WidgetsBinding.instance.addPostFrameCallback(
        (_) => ChangeModeManNotify(selectedMode).dispatch(context));
  }
        ...
        children: [
          ButtonsTabBar(
            ...
            onTap: (index) {
              ...
              ChangeModeManNotify(selectedMode).dispatch(context);
              setState(() {});
            },
            tabs: [
              Tab(
                ...
                children: [
                  FutureBuilder(
                      future: RestClient(Dio()).searchOrders(
                          OrderMode.MAN, widget.city.id, widget.city.id),
    ...
    Navigator.push(
        ...
        MaterialPageRoute(
            builder: (context) => TransportationViewPage(
                transportation: transportationEntity, title: "Автоовоз")));
  }
...
class ChangeModeManNotify extends Notification {
  Mode mode;
  ChangeModeManNotify(this.mode);
}

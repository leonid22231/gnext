...
class ParsinggazellesPage extends StatefulWidget{
  const ParsinggazellesPage({super.key});

  @override
  State<StatefulWidget> createState() => _ParsinggazellesPageState();

}
class _ParsinggazellesPageState extends State<ParsinggazellesPage>{
  Future<List<MessageEntity>> messages = Future.value([]);
  late Socket socket;
  TextEditingController _controller = TextEditingController();
  bool storyLoad = false;
  List<UserStoryModel> allStories = [];
  String chat_name = GlobalsWidgets.chats[1];
  @override
  void initState() {
    super.initState();
    getMessages();

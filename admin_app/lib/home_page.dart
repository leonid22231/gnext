  ...
  Widget build(BuildContext context) {
    actions = [
      ...
      ActionModel(
          ...
          child: ControlLocationPage(selectMode: true,),
      ...
      ActionModel(
          name: "Фильтр чата",
          description: "Здесь вы можете добавить слова, которые запрещены в чате",
      ...
      ActionModel(
          ...
          child: ControlUsersPage(selectMode: true,),
    ...
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text("Админ панель GNext", style: TextStyle(fontSize: 18.sp, fontWeight: FontWeight.bold, color: mainColor),),
      ),
          ...
          child: Column(
            children: [
                              ...
                              children: [
                                ...
                                InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child: Text("Выход", textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14.sp, color: Colors.white),),
                                    ),
                                  ),
                                )
                              ],
                            ...
                            child: FutureBuilder(
                              ...
                              builder: (context,snapshot){
                                if(snapshot.hasData){
                                  ...
                                  return Column(
                                    children: [
                                      Text("Статистика:", style: TextStyle(color: Colors.white, fontSize: 18.sp, fontWeight: FontWeight.bold),),
                                      SizedBox(height: 2.h,),
              ...
              Container(
                ...
                child: Center(
                    child: Text("Возможности", style: TextStyle(fontSize: 22.sp, fontWeight: FontWeight.bold, color: Colors.white),),
                  ),
              ),
              SizedBox(height: 2.h,),
              SizedBox(
  ...
  Widget action(IconData icon,String name, String description, StatefulWidget child, var secondChild){
    return InkWell(
      ...
      onTap: (){
        ...
        MaterialPageRoute(builder: (context)=>child)).then((value){
          if(secondChild!=null){
            if(secondChild == ControlChatsPage && value!=null){
              Navigator.push(context,
                  MaterialPageRoute(builder: (context)=>ControlChatsPage(location: value,)));
            }else if(secondChild == ControlCompaniesPage && value!=null){
              Navigator.push(context,
                  MaterialPageRoute(builder: (context)=>ControlCompaniesPage(location: value,)));
            }else if(secondChild == ControlWalletPage && value!=null){
              Navigator.push(context,
                  MaterialPageRoute(builder: (context)=>ControlWalletPage(user: value,)));
            }
          }
          setState(() {
      ...
      child: Ink(
        ...
        child: Padding(
            ...
            child: Column(
              children: [
                Icon(icon, size: 6.w,color: Colors.white,),
                SizedBox(
                  height: 3.h,
                  child: TextScroll(
                    name,
                ...
                SizedBox(height: 1.h,),
                Expanded(
                    child: Text("*$description", style: TextStyle(fontSize: 12.sp, color: Colors.white.withOpacity(0.8)),)
                )
              ],
            ),
          ),
...
Widget _value(String name, String value){
    return Row(
      ...
      children: [
        Text("$name:", style: TextStyle(color: Colors.white, fontSize: 15.sp, fontWeight: FontWeight.bold),),
        Text(value, style: TextStyle(color: Colors.white, fontSize: 15.sp, fontWeight: FontWeight.bold),),
      ],
    );
}
}
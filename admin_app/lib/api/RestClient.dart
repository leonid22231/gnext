...
abstract class  RestClient{
  ...
  @GET("user/login")
  Future<UserEntity> login(@Query("phone") String phone, @Query("password") String password);
  @POST("user/register")
  Future<UserEntity> register(@Query("phone") String phone, @Query("password") String password,@Query("name") String name,@Query("surname") String surname,@Query("number") String? number, @Query("role") UserRole role,@Query("countryId") int countryId,@Query("cityId") int cityId, @Query("uid") String uid,@Query("notifyToken") String notifyToken);
  @GET("user/uid")
  ...
  @MultiPart()
  @POST("admin/file")
  Future<void> fileMessage(@Query("uid") String uid,@Query("countryId") int countryId,@Query("cityId") int cityId, @Query("name")String name,@Query("type")MessageType type, @Part(name: "file")File file);
  @GET("chat/findId")
  ...
  @POST("orders/create")
  Future<void> createOrder(@Query("uid")String uid,@Query("startDate")DateTime startDate,@Query("endDate")DateTime endDate,@Query("price")double price,@Query("customPrice")bool customPrice, @Query("outcity")bool outcity, @Body() PropertiesModel properties);
  @GET("orders/my")
  ...
  @GET("admin/login")
  Future<String> adminLogin(@Query("phone")String phone, @Query("password")String password);
  @POST("admin/login")
  ...
  @GET("admin/chats")
  Future<List<ChatEntity>> findChats(@Query("countryId")int countryId,@Query("cityId")int cityId);
  @GET("admin/chats/messages")
  Future<List<MessageEntity>> getMessagesByLocation(@Query("countryId")int countryId,@Query("cityId")int cityId,@Query("name")String name,);
  @GET("admin/filters")
  ...
  Future<void> walletEvent(@Query("uid")String uid, @Query("type")WalletEvent type,@Query("sum") double sum);
  ...
  Future<void> changeRole(@Query("uid")String uid, @Query("role")UserRole role);
  @GET("admin/companies")
  Future<List<CompanyEntity>> findCompanies(@Query("countryId") int countryId, @Query("cityId") int cityId,@Query("category") Categories category);
  @POST("admin/setManager")
  Future<void> setManager(@Query("uid")String uid, @Query("id")int id);
  @POST("admin/companies/add")
  @MultiPart()
  Future<void> addCompany(@Query("countryId") int countryId, @Query("cityId") int cityId,@Query("category") Categories category,@Query("name")String name,@Query("phone")String phone,@Query("street")String street,@Query("house")String house, @Part(name: "photo")File? file);
  ...
  Future<String> createCity(@Query("countryId")int id,@Query("name")String name);
}
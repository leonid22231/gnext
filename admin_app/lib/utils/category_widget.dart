...
class CategoryWidget extends StatefulWidget {
  ...
  Categories category;
  Function() update;
  CategoryWidget({required this.update, required this.name, required this.companies, required this.city, required this.category, super.key});
        ...
        children: [
          ...
          SizedBox(
            ...
            child: OutlinedButton(
                style: OutlinedButton.styleFrom(backgroundColor: Colors.green, side: BorderSide(color: Colors.green)),
                onPressed: () {
                  String? temp_name;
                  String? temp_phone;
                  String? temp_street;
                              ...
                              content: Container(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    widget.category == Categories.auto
                                        ? SizedBox(
                                            width: 50.w,
                                            height: 6.h,
                                            child: OutlinedButton(
                                        ...
                                        children: [
                                          ...
                                          TextButton(
                                              onPressed: () {
                                                ...
                                                client.addCompany(0, city.id, widget.category, temp_name!, ph, temp_street!, temp_house!, file).then((value) {
                                                  widget.update.call();
                                                  Navigator.pop(context);
      ...
      child: InkWell(
        ...
        child: Ink(
          ...
          child: Row(
            ...
            children: [
              IconButton(
                  onPressed: companyEntity.category == Categories.auto
                      ? null
                      : () {
                          Navigator.of(context)
                              .push(MaterialPageRoute(
                                  builder: (context) => ControlUsersPage(
                                        filter: true,
                                        selectMode: true,
                                      )))
                              .then((value) {
                  ...
                  icon: Icon(
                    Icons.person,
                    color: companyEntity.category == Categories.auto ? Colors.transparent : Colors.green,
                  )),
              Text(
                companyEntity.name,
                style: TextStyle(color: mainColor, fontWeight: FontWeight.bold, fontSize: 15.sp),
              ),
              IconButton(
                  onPressed: () {
                    Dio dio = Dio();
